...
class HomeController extends Controller
{
    ...
    /**
     * @Route("/happymessage", name="get_happy_message")
     */
    public function getHappyMessageAction() {
        
        $mgenerator = $this->get('get_message');
        $randomMessage = $mgenerator->getHappyMessage();
        
        return $this->render('services/random_message.html.twig', ['message' => $randomMessage]);
    }
