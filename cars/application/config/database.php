...
$db['ibest']['hostname'] = IBEST_DB_HOST;
$db['ibest']['username'] = IBEST_DB_USER;
$db['ibest']['password'] = IBEST_DB_PASS;
$db['ibest']['database'] = IBEST_DB_NAME;
...
$db['mobile']['hostname'] = MOBILE_DB_HOST;
$db['mobile']['username'] = MOBILE_DB_USER;
$db['mobile']['password'] = MOBILE_DB_PASS;
$db['mobile']['database'] = MOBILE_DB_NAME;
